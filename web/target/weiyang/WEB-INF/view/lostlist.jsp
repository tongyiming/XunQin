                        ...
                        <div class="row row-plus">
                            <div class="col-md-8 ad">
                                <div class="row" style="display: flex; flex-direction: row">
                                    <div class="col-ms-3" style="margin-top:50px;width:20%;padding-left:2%">
                                        <span class="help-word">已发布寻人信息</span>
                                    </div>
                                    <div class="col-ms-9" style="width: 80%;padding-top:3%">
                                        ...
                                        <span class="font-num"><%=lostNum/10000%10%></span>
                                        <span class="font-num"><%=lostNum/1000%10%></span>
                                        <span class="font-num"><%=lostNum/100%10%></span>
                                        <span class="font-num"><%=lostNum/10%10%></span>
                                        <span class="font-num"><%=lostNum%10%></span>
                                    </div>
                                </div>
                            </div>
                            <%
                            ...
                            %>
                                <div class="col-md-4 num">
                                    <div class="row sure">
                                        <span>发布寻亲启示</span>
                                        <a href="javascript:void(0);" onclick="showmess()" class="btn btn-primary">发布信息</a>
                                    </div>
                                    <div class="row sure" style="margin-top:20px">
                                        <span>信息还不全？</span>
    ...
    <div class="row" style="margin:30px 10%">
        ...
        <div class="col-md-3" style="padding-bottom: 15px;padding-top: 15px">
            <div class="card">
                ...
                <img href="/lostmess/<%=id%>" src="<%=picture%>" alt="失踪者照片">
                <div class="message">
                    <div>姓名：<span><%=list.getName()%></span></div>
    ...
    <div class="containers large">
        <ul>
            ...
            <%
                if(pagenow < pagemax){
            %>
            <li><a href="/lostmess/list?thenstart=<%=pagenow+1%>&type=0">NEXT</a></li>
            <% } %>
