...
<div class="main-container">
    ...
    <div class="second-container">
        ...
        <div class="row row-plu" style="border-bottom:1px #ccc solid;">
            ...
            <a href="realmess" title="待完善" class="btn btn-link btn-link-move" style="text-decoration:none;font-size: 16px;" id="self">实名认证</a>
        </div>
        ...
        <form class="form-horizontal" role="form" action="" method="post" style="margin-top:30px;">
            ...
            <div class="form-group" id="input-realnum">
            ...
            <div class="form-group" id="input-picture">
                    ...
                    <div class="col-sm-9">
                        <div class="file-style col-sm-4" id="pic1" align="center" style="width:;">
                ...
                height:230px; opacity:0;cursor:pointer;z-index:999;margin-top:-138px" id="idfrontpic" name="idfrontpic">
                         ...
                         <div class="file-style col-sm-4" align="center" id="pic2">
