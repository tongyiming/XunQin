...
<head>
    ...
    <script type="text/javascript">
        ...
        function testall(){
            ...
            var link = window.XMLHttpRequest?new XMLHttpRequest():new ActiveXObject("Microsoft.XMLHttp");
            link.open("post","/gaminmess/update ",true);
...
<div class="container" style="margin-top:30px;margin-left:0;margin-right:0">
    ...
    <form class="form-horizontal" role="form" action="" method="post" style="margin-top:30px">
        ...
        <div class="form-group" id="input-name">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control mess" id="gaminage" name="gaminage" value="<%=gaminmess.getAge()%>" autofocus>
            </div>
        </div>
        ...
        <div class="form-group" id="input-sex">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <%
                int sex = gaminmess.getSex();
                if(sex == 0){
            %>
            <label class="radio-inline">
                <input type="radio"  value="0" name="gaminsex" checked>男&nbsp;&nbsp;&nbsp;
            </label>
            <label class="radio-inline">
            ...
            <label class="radio-inline">
                <input type="radio"  value="1" name="gaminsex" checked>女
            </label>
            <%
                }else{
            %>
        ...
        <div class="form-group" id="input-picture">
			...
			height:250px;opacity:0;cursor:pointer" id="gaminpicture" name="gaminpicture">
                ...
                <div class="col-md-3 pic-style">
                    <img src="<%=gaminmess.getPicture_list()%>" id="pic" style="width:210px; height:250px;">
                </div>
                <div class="col-sm-3">
        ...
        <div class="form-group" id="input-height">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control mess" id="gaminheight" name="gaminheight" value="<%=gaminmess.getHeight()%>">
            </div>
        </div>
        &nbsp;
        &nbsp;
        ...
        <div class="form-group" id="input-date">
            ...
            <div class="col-sm-9">
                <%
                    if(gaminmess.getFind_time() == null){
                %>
                <input type="date" class="form-control mess" id="gamindate" name="gamindate">
                <%
                    }else{
                %>
                <input type="date" class="form-control mess" id="gamindate" name="gamindate" value="<%=gaminmess.getFind_time().substring(0,10)%>">
                <%
                    }
                %>
            </div>
        ...
        <div class="form-group" id="b-address">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control mess" id="lostaddress" name="lostaddress" value="<%=gaminmess.getFind_place()%>">
            </div>
        </div>
        &nbsp;
        &nbsp;
        <div class="form-group" id="input-feature">
            ...
            <div class="col-sm-9">
                <textarea rows="4" type="text" class="form-control mess" id="gaminfeature" name="gaminfeature"><%=gaminmess.getFeature()%></textarea>
            </div>
        </div>
        &nbsp;
        &nbsp;
        <div class="form-group" id="input-othermess">
            ...
            <div class="col-sm-9">
                <textarea rows="4" type="text" class="form-control mess" id="gaminothermess" name="gaminothermess"><%=gaminmess.getOther_message()%></textarea>
            </div>
        </div>
        <br><br>
