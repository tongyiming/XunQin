...
<div class="container container-plus">
   	<form class="form-horizontal form-plus" role="form" action="/goto/login" method="post" onSubmit="checkAll()" id="loginform">
    	<h1>用户登录</h1>
       	<div class="form-group" id="input-name">
        	<div  class="col-sm-10 col-sm-offset-1">
            	<input type="text" class="form-control input-size" style="height: 50px;font-size: 16px;" id="username" name="username" autofocus placeholder="邮箱" onBlur="checkName()">
                <span class="error" id="namespan"></span>
        	</div>
    	</div>
        <div class="form-group" id="input-pass">
        	<div class="col-sm-10 col-sm-offset-1">
            	<input type="password" class="form-control input-size" style="height: 50px;font-size: 16px;" id="userpass" name="userpass" placeholder="密码" onBlur="checkPass()">
