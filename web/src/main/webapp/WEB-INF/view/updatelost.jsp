...
<head>
    ...
    <script type="text/javascript">
        ...
        function test2(){
            ...
            var picpath = document.getElementById("pic").src.substring(21);
        ...
        function test1(){
            ...
            var link = window.XMLHttpRequest?new XMLHttpRequest():new ActiveXObject("Microsoft.XMLHttp");
            link.open("post","/lostmess/update",true);
...
<div class="container" style="margin-top:30px;margin-left:0;margin-right:0">
    ...
    <form class="form-horizontal" role="form" action="" method="post" style="margin-top:30px">
        ...
        <div class="form-group" id="input-name">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control mess" id="lostname" name="lostname" value="<%=lostmess.getName()%>" autofocus>
            </div>
        </div>
        &nbsp;
        &nbsp;
        <div class="form-group" id="input-type">
            ...
            <%
                int type = lostmess.getFind_type();
                if(type == 0){
            %>

            <label class="radio-inline">
                <input type="radio"  value="0" name="losttype" checked>家寻宝贝
            </label>
            <label class="radio-inline">
            ...
            <label class="radio-inline">
                <input type="radio"  value="1" name="losttype" checked>宝贝寻家
            </label>
            <%
                }
            %>
        ...
        <div class="form-group" id="input-sex">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <%
                int sex = lostmess.getSex();
                if(sex == 0){
            %>
            <label class="radio-inline">
                <input type="radio"  value="0" name="lostsex" checked>男&nbsp;&nbsp;&nbsp;
            </label>
            <label class="radio-inline">
            ...
            <label class="radio-inline">
                <input type="radio"  value="1" name="lostsex" checked>女
            </label>
        ...
        <div class="form-group" id="input-picture">
            ...
            <div class="col-sm-9">
                <div class="file-style col-md-3">
                    <input type="file" onChange="add_files(this.files)" style="width:210px;
			height:250px;opacity:0;cursor:pointer" id="lostpicture" name="lostpicture">
                </div>
                <div class="col-md-3 pic-style">
                    <img src="<%=lostmess.getPicture_list()%>" id="pic" style="width:210px; height:250px;">
                </div>
                <div class="col-sm-3">
                    <button type="button" class="btn btn-primary btn-margin" onclick="test();">确认图片</button>
                </div>
            </div>
        </div>
        &nbsp;
        ...
        <div class="form-group" id="input-birthday">
            ...
            <div class="col-sm-9">
                <input type="date" class="form-control mess" id="lostbirthday" name="lostbirthday" value="<%=lostmess.getBirthday().substring(0,10)%>">
            </div>
        </div>
        &nbsp;
        &nbsp;
        ...
        <div class="form-group" id="b-address">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control mess" id="lostaddress" name="lostaddress" value="<%=lostmess.getNative_place()%>">
            </div>
        </div>
        &nbsp;
        &nbsp;
        <div class="form-group" id="input-height">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control mess" id="lostheight" name="lostheight" value="<%=lostmess.getHeight()%>">
            </div>
        </div>
        &nbsp;
        &nbsp;
        ...
        <div class="form-group" id="input-blood-type">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <%
                int blood = lostmess.getBlood_type();
                if(blood == 0){
            %>
            <label class="radio-inline">
                <input type="radio"  value="0" name="lostbloodtype" checked>A型
            </label>
            <label class="radio-inline">
            ...
            <label class="radio-inline">
                <input type="radio"  value="1" name="lostbloodtype" checked>B型
            </label>
            <label class="radio-inline">
                <input type="radio"  value="2" name="lostbloodtype">AB型
            </label>
            ...
            <label class="radio-inline">
                <input type="radio"  value="2" name="lostbloodtype" checked>AB型
            </label>
            <label class="radio-inline">
                <input type="radio"  value="3" name="lostbloodtype">O型
            </label>
            ...
            <label class="radio-inline">
                <input type="radio"  value="3" name="lostbloodtype" checked>O型
            </label>
            <label class="radio-inline">
                <input type="radio"  value="4" name="lostbloodtype">其它
            </label>
            ...
            <label class="radio-inline">
                <input type="radio"  value="4" name="lostbloodtype" checked>其它
            </label>
            <%
                }else{
            %>
        ...
        <div class="form-group" id="input-date">
            ...
            <div class="col-sm-9">
                ...
                %>
                <input type="date" class="form-control mess" id="lostdate" name="lostdate" value="<%=lostmess.getLost_date().substring(0,10)%>">
                <%
                    }
                %>
            </div>
        ...
        <div class="form-group" id="b-place">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control mess" id="lostplace" name="lostplace" value="<%=lostmess.getLost_place()%>">
            </div>
        </div>
        &nbsp;
        &nbsp;
        <div class="form-group" id="input-feature">
            ...
            <div class="col-sm-9">
                <textarea rows="4" type="text" class="form-control mess" id="lostfeature" name="lostfeature" ><%=lostmess.getFeature()%></textarea>
            </div>
        </div>
        &nbsp;
        &nbsp;
        <div class="form-group" id="input-othermess">
            ...
            <div class="col-sm-9">
                <textarea rows="4" type="text" class="form-control mess" id="lostothermess" name="lostothermess" ><%=lostmess.getOther_message()%></textarea>
            </div>
        </div>
        &nbsp;
        &nbsp;
        <div class="form-group" id="input-phone">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control mess" id="phone" name="phone" value="<%=lostmess.getPhone()%>">
            </div>
        </div>
        &nbsp;
        &nbsp;
        <div class="form-group" id="input-email">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control mess" id="email" name="email" value="<%=lostmess.getEmail()%>">
            </div>
        </div>
        <br><br><br>
        &nbsp;
