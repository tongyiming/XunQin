...
public class Usermess {
    ...
    public Usermess(int id, int user_id, int realname_flag, String picture, String username, String nickname, int love_count, int age, int sex, String telephone, double account_balance) {
        this.id = id;
